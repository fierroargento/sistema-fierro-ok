...
def certificar(configuracion=None):
    ...
    return {"modo":"certificacion_entorno_ensayo_sin_secretos","aprobado":not hallazgos,"entorno":entorno,"laboratorio_forzado":forzado,"base_configurada":bool(base),"base_separada":bool(actual and productiva and len(productiva)==64 and actual!=productiva),"huella_base_ensayo":actual,"hallazgos":hallazgos,"controles":{"credenciales_expuestas":0,"conexiones_realizadas":0,"escrituras":0},"diagnostico_runtime":diagnostico}
