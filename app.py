...
from models.personas import TurnoLaboralPlanificado, NovedadLaboralPreparatoria, CompetenciaEmpleadoPreparatoria
from models.postventa import CasoPostventa, PropuestaResolucionPostventa, ItemCasoPostventa, EvidenciaCasoPostventa
...
from models.propuesta_pedido_tienda_nube import (
...
def ml_datos_apb_pedido(pedido):
    return ml_datos_apb_pedido_service(
        pedido,
...
from modules.bot_ml.contacto import (
    pedido_es_plegable_pp6040 as pedido_es_plegable_pp6040_contacto,
    generar_mensaje_contacto_ml as generar_mensaje_contacto_ml_contacto,
)


def pedido_es_plegable_pp6040(pedido):
    return pedido_es_plegable_pp6040_contacto(pedido)


def generar_mensaje_contacto_ml(pedido):
    return generar_mensaje_contacto_ml_contacto(
        pedido,
        es_ml_acordas_entrega,
    )
...
def ml_aplicar_apb_en_pedido(pedido, order, shipment, billing_info=None):
    return ml_aplicar_apb_en_pedido_service(
        pedido,
        order,
        shipment,
        billing_info,
...
def ml_resolver_ids_desde_recurso_mensaje(resource):
    return ml_resolver_ids_desde_recurso_mensaje_api(
        resource,
        ml_api_get,
    )
...
def ml_obtener_ids_mensajes_pendientes():
    return ml_obtener_ids_mensajes_pendientes_api(
        ml_api_get,
    )
...
@app.route("/pedido/<int:id>/sync-tracking", methods=["POST"])
...
registrar_modulos_web(
    ...
    dependencias={
        ...
        "modelos": {
            ...
            "CompetenciaEmpleadoPreparatoria": CompetenciaEmpleadoPreparatoria,
            "CasoPostventa": CasoPostventa,
            "PropuestaResolucionPostventa": PropuestaResolucionPostventa,
            "ItemCasoPostventa": ItemCasoPostventa,
            "EvidenciaCasoPostventa": EvidenciaCasoPostventa,
            ...
            "ObservacionComercialCanal": ObservacionComercialCanal,
