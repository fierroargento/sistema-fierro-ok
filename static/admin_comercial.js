(function () {
  ...
  function iniciarBuscadorProductoPolitica() {
    const buscador = document.getElementById("buscar-producto-politica");
    const selector = document.getElementById("producto-politica");
    const opciones = document.getElementById("opciones-producto-politica");
    const resultado = document.getElementById("resultado-producto-politica");
    if (!buscador || !selector || !opciones || !resultado) return;
