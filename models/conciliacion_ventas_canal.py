...
class VentaCanalItem(db.Model):
    ...
    publicidad_esperada_centavos = db.Column(db.BigInteger, default=0, nullable=False)
    financiacion_esperada_centavos = db.Column(db.BigInteger, default=0, nullable=False)
    devoluciones_esperadas_centavos = db.Column(db.BigInteger, default=0, nullable=False)
