...
class CostoFijoVersion(db.Model):
    ...
    importe_periodo_centavos = db.Column(db.BigInteger, nullable=False, default=0)
    naturaleza = db.Column(db.String(20), nullable=False, default="fijo")
    periodicidad = db.Column(db.String(20), nullable=False, default="mensual")
    meses_cobertura = db.Column(db.Numeric(9, 2), nullable=False, default=1)
    vigente = db.Column(db.Boolean, default=True, nullable=False, index=True)
    vigente_desde = db.Column(db.DateTime, nullable=False, index=True)
    vigente_hasta = db.Column(db.DateTime)
    comprobante_referencia = db.Column(db.String(120))
