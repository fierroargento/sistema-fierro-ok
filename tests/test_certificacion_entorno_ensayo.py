...
def test_ignora_funciones_internas_de_shell_render():
 e=base();e["BASH_FUNC_copy_secret_files%%"]="() { :; }";e["BASH_FUNC_remove_secret_files%%"]="() { :; }";r=certificar(e);assert r["aprobado"]
